...
public class Main {
	...
	static int menu = 0;
	static String opcoes[] = { "1. Cadastrar Vacina", "2. Listar Todas", "3. Alterar Dados", "4. Excluir Registro",
	...
	public static void listarTodas() {
		System.out.println("Pet\tVeterinário\tVacina\tData\tDias");
		for (int i = 0; i < vacinas.size(); i++) {
			System.out.println("["+ i + "]"+ vacinas.get(i).toString());
		}
	
	}
	public static void excluir () {
		System.out.println("Digite o índice da vacina: ");
	...
	public static void buscarPet(){
		...
		System.out.println("Indice\tPet\tVeterinario\tVacina\tData\tDias");
		for(int i = 0; i < vacinas.size(); i++){
	...
	public static void alterar() throws ParseException{
		...
		int indice = scan.nextInt();
		System.out.println("Pet\tVeterinário\tVacina\tData\tDias");
		System.out.println(indice + "\t" + vacinas.get(indice).toString());
